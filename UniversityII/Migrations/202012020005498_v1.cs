namespace UniversityII.Migrations
{
    ...
    public partial class v1 : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Departament_DespartmentID = c.Int(),
                    })
                .PrimaryKey(t => t.CourseID)
                .ForeignKey("dbo.Departments", t => t.Departament_DespartmentID)
                .Index(t => t.Departament_DespartmentID);
            
            CreateTable(
                "dbo.Departments",
                c => new
                    {
                        DespartmentID = c.Int(nullable: false, identity: true),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Courses", "Departament_DespartmentID", "dbo.Departments");
            ...
            DropIndex("dbo.Courses", new[] { "Departament_DespartmentID" });
